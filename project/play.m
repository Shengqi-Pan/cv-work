...
RecLUp = [floor(YCenter - R / 2 - R), floor(XCenter - R / 2)];%矩形左上角的点为RECLUp
RecRUp = [floor(YCenter - R / 2 - R), floor(XCenter + R / 2)];%矩形右上角的点为RecRUp
